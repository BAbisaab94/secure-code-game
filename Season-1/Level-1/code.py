...
MAX_ITEM_AMOUNT = 100000      # maximum price of item
MAX_QUANTITY = 100            # maximum quantity per item
MIN_QUANTITY = 0              # minimum quantity (exclusive)
MAX_TOTAL = 1e6               # maximum total order amount
...
def validorder(order: Order):
    ...
    for item in order.items:
        if item.type == 'payment':
            ...
            # Validate quantity is integer, within range
    ...
    # Check if totals exceed maximum allowed
